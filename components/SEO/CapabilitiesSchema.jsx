 ...
 * Based on real deployment use cases (Railway, Enterprise Campus, Enterprise)
...
const VMS_PLATFORM_SCHEMA = {
  ...
  description: 'Enterprise-grade AI-powered Video Management System by VMukti. Supports 10,000+ cameras, 26+ AI analytics including face recognition, ANPR, crowd detection, fire/smoke detection, and behavioral analytics. Deployed across railways, enterprise campuses, enterprises, and critical infrastructure globally.',
...
const ICCC_PLATFORM_SCHEMA = {
  ...
  description: 'VMukti Integrated Command and Control Center platform for enterprise campuses, railways, airports, and critical infrastructure. Centralized real-time monitoring with AI-powered incident detection, automated alerting, GIS integration, and multi-agency coordination.',
...
// ── Railway & Enterprise Campus AI Use Cases Schema ──
const USE_CASES_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'VMukti AI Solutions for Railways & Enterprise Campuses',
  description: 'VMukti deploys 26+ AI-powered video analytics use cases for Indian Railways, enterprise campuses, and critical infrastructure. From platform overcrowding detection to fire safety, criminal face recognition to cleanliness monitoring - VMukti AI transforms surveillance from passive recording to proactive intelligence.',
  provider: {
    '@type': 'Organization',
    name: 'VMukti Solutions',
    url: 'https://www.vmukti.com'
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Fire & Smoke Safety Alert', description: 'AI-powered early fire and smoke detection with instant alerts for railways, warehouses, and enterprise campuses' }},
...
const INDUSTRIES_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Enterprise Campuses & Government', description: 'Enterprise Command Center platforms for enterprise campus operations, traffic management, public safety, and urban analytics' },
