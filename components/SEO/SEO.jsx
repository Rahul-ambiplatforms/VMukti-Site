 ...
 * Global enterprise positioning for VMS, EMS, Enterprise Command Center platforms
 *
 * Props:
...
const SEO = ({
  ...
  const finalDescription = description ||
    'VMukti Solutions: STQC-certified enterprise cloud VMS, EMS, and Enterprise Command Center platform. 900+ global deployments, 1B+ camera feeds processed.';

  // Default keywords if not provided
  const finalKeywords = keywords ||
    'enterprise cloud VMS, video management system, Enterprise Command Center platform, EMS, STQC certified, global surveillance';
