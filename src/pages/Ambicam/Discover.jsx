...
const Discover = () => {
  return (
    <>
      <Flex bg="white" borderRadius="24px" p={10} justifyContent="space-between" alignItems="center" gap={10} position="relative">
        <Flex direction="column" flexGrow={10}>
          {/* main heading */}
          <Flex fontSize="48px" fontWeight="600" gap={2} mb={4}>
            <Text>Discover </Text>
            <Text color="#DB7B3A">Smarter Security</Text>
          </Flex>
          <Text fontSize="16px" fontWeight="400">Elevate your safety with Ambicam&apos;s innovative cameras and cloud platform.</Text>

          {/* links section */}
          <Flex fontSize="16px" alignItems="center">
            <Text>Contact us:</Text>
            <Link><Text color="#4CC9F0">contact@ambicam.in</Text></Link>
            ...
            <Text fontSize="14px" fontWeight="500">(+91) 968 777 9999</Text>
          </Flex>
        </Flex>
        <Flex flexGrow={1}>
