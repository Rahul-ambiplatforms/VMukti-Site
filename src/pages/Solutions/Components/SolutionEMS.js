...
const SolutionEMS = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: [
        'The Enterprise Command Center is a centralized intelligence hub that integrates live video feeds, IoT sensors, and AI-powered analytics across security systems. Designed for smart city management, critical infrastructure monitoring, and emergency response, it ensures real-time situational awareness and security coordination.',
      ],
      description2: [
        <>
          <h3 style={{ fontWeight: 'bold', marginBottom: '16px' }}>
