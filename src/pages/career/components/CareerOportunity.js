...
const CareerOportunity = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name="description" content="Explore exciting career opportunities at Vmukti. Join our innovative team and contribute to cutting-edge technology solutions. Apply now!" />
    </Helmet>
      <Box mt="2%">
