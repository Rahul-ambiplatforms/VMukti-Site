...
const DashboardItem = ({ item }) => (
  ...
  >
    ...
    >
      <Text fontSize="16px" fontWeight="600" color="black" mb={1} letterSpacing="-0.24px">
        {item.title}
      </Text>
      <Box
        width="5%"
        ...
        mb={2}
      />
      <Text fontSize="16px" fontWeight="500" color="black" mb={1} letterSpacing="-0.24px">
        {item.description}
      </Text>
    </Box>
  </Box>
...
const NavigationButton = ({ onClick, direction }) => (
  ...
  >
    ...
    >
      <path
        d={direction === "left" ? "M0.076934 7.76919L7.46155 15.1538L7.46155 0.38458L0.076934 7.76919Z" : "M7.92307 7.99997L0.538452 0.615356L0.53845 15.3846L7.92307 7.99997Z"}
        fill="#3F77A5"
      />
    </svg>
  </Button>
...
const EventSpotlight = () => {
  ...
  const dashboardItems = [
    { image: "./assets/EventSpot.png", title: "AI Surveillance", description: "Advanced monitoring solutions" },
    { image: "./assets/EventSpot.png", title: "Smart Automation", description: "Efficiency-driven systems" },
    { image: "./assets/EventSpot.png", title: "Security Systems", description: "Next-gen protection" },
    { image: "./assets/EventSpot.png", title: "Connected World", description: "Seamless integration" },
  ];
  ...
  const prevSlide = () => {
    setDirection(-1);
    setCurrentIndex((prev) => (prev - 1 + dashboardItems.length) % dashboardItems.length);
  };
  ...
  return (
    ...
    <Flex direction="column" position="relative" overflow="hidden" px={{ base: 4, md: 8 }}>
      ...
      <Box pt={{ base: 8, md: 16 }} mb={{ base: 4, md: 8 }}>
        <Text fontSize={{ base: "20px", md: "32px", lg: "48px" }} fontWeight="600" lineHeight="normal" textAlign={{ base: "center", md: "left" }}>
          <Text as="span" color="#3F77A5">Event Spotlight: </Text>
          <Text as="span" color="black">Where </Text>
          <Text as="span" color="#DB7B3A">Innovation </Text>
          <Text as="span" color="black">Meets <br /> Engagement</Text>
          <Text as="span" color="#3F77A5">.</Text>
        </Text>
      </Box>

      {/* Dynamic Dashboard */}
      <Flex direction={{ base: "column", md: "row" }} width="100%" mb={{ base: "4%", md: "8%" }} alignItems={{ base: "center", md: "flex-start" }}>
        {/* Left Section */}
        <Flex direction="column" width={{ base: "100%", md: "25%" }} mb={{ base: 8, md: 0 }} alignItems={{ base: "center", md: "flex-start" }}>
          <Box mb={4}>
          ...
          <Box
            ...
            textAlign={{ base: "center", md: "left" }}
          >
            <Text fontSize={{ base: "12px", md: "16px" }} color="#000000" fontWeight="500">
          ...
          <Box
            ...
            textAlign="center"
          >
            <Text fontSize={{ base: "24px", md: "36px" }} fontWeight="600" color="black">
              Incoming Events
            </Text>
          </Box>
        </Flex>
        ...
        <Box width={{ base: "100%", md: "75%" }} position="relative" overflow="hidden" borderRadius="24px" height={{ base: "auto", md: "521px" }} bg="white" py={6}>
          ...
          {/* Navigation Arrows */}
          <Flex position="absolute" bottom={4} left={6} gap="0.5" justifyContent={{ base: "center", md: "flex-start" }} width="100%">
