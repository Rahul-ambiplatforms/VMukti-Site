    ...
    return (
        <Box maxW="1445px" mx="auto" px="33px" py="20px">
            ...
            <Flex flexWrap="wrap" gap="20px" mb="30px">
                ...
                >
                    <Heading fontSize="18px" fontWeight="bold" mb="20px">Who we are</Heading>
                    <Divider
                ...
                <Flex flexDirection="column" flex="1" minW="250px">
                    ...
                    >
                        ...
                        >
                            ...
                            <Image src="/assets/arrowuprb.svg" alt="Arrow Up" width="14px" height="14px" />
                        </Button>
                    </Box>
                </Flex>
                ...
                <Flex gap={4} justify="center" mt={4}>
                    {[
                        ...
                        <Link
                            ...
                            href={social.link}
                            color="blue.500"
                            _hover={{ color: "blue.700", transform: "scale(1.2)", transition: "all 0.3s ease" }}
                        >
