    ...
    return (
        <Box>
            <Flex bg="#F3F3F3" w="100%" position="relative" overflow="hidden" direction="column" minH="100%">
                ...
                >
                    {/* New Box behind the Dashboard Image */}
                    <Box
                        position="absolute"
                        top="66%"
                        right="16"
                    ...
                    <Image
                        ...
                        top="60%"
                        right="16"
                        transform="translateY(-50%) perspective(1095px) "
                        w="100%"
                        h="100%"
                        objectFit="contain"
                        zIndex={3} // Ensure it stays above the box
                    />
                </Flex>

                {/* Content Section */}
                <Container maxW="container.xl" position="relative" zIndex={3} flex="1" display="flex" alignItems="center">
                    <Flex
