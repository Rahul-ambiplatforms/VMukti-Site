...
const seoPageDataExpansion3 = {
  "latin-america-cloud-vms": {
    ...
    "heroDescription": "Deploy scalable video management systems across Brazil, Mexico, and Colombia with VMukti edge-optimized cloud platform.",
    "category": "geo",
    "sections": [
      {
  ...
  "smart-factory-surveillance": {
    "slug": "/smart-factory-surveillance",
    "title": "Smart Factory Surveillance | VMukti Solutions",
    "metaDescription": "Industry 4.0 surveillance: worker safety, equipment monitoring, predictive maintenance. AI-powered visibility for smart manufacturing.",
    "keywords": ["smart factory surveillance", "Industry 4.0 monitoring", "manufacturing safety camera", "predictive maintenance AI", "industrial equipment monitoring"],
    "heroTitle": "Smart Factory Surveillance for Industry 4.0",
    "heroSubtitle": "Safety, Efficiency, Predictive Maintenance",
    "heroDescription": "VMukti integrates video surveillance with IoT sensor data to monitor worker safety, detect equipment anomalies, and predict maintenance needs.",
    "category": "industry",
    "sections": [
      {
