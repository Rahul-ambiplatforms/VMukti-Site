...
export const homepageSchema = {
  ...
  '@type': 'CollectionPage',
  name: 'VMukti Solutions - Enterprise AI Video Intelligence & Cloud VMS Platform',
  description: 'VMukti is a leading provider of enterprise cloud VMS with 26+ AI analytics models. STQC certified. 18+ years, 900+ deployments, 1B+ camera feeds processed globally.',
  ...
  mainEntity: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        url: 'https://www.vmukti.com/solutions/enterprise-command-center',
      },
      {
        '@type': 'ListItem',
        position: 4,
...
export const localBusinessSchema = {
  ...
  description: 'Enterprise cloud VMS, EMS, and Enterprise Command Center provider',
  address: {
    '@type': 'PostalAddress',
