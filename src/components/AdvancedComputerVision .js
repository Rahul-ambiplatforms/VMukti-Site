      ...
      >
        ...
        >
          {cards.map((card, index) => (
            <Box
              key={index}
              width={activeCard === index ? { base: "123px", md: "814px" } : { base: "80px", md: "149px" }} // Decreased card size for small screens
              height={{ base: "295px", md: "439px" }} // Increased height for small screens
              // flexShrink={0}
              borderRadius="24px"
              bgColor={activeCard === index ? (card.type === 'video' ? '#f3f3f3' : '#a8c0d3') : '#becedc'}
