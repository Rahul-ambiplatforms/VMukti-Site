  ...
  return (
    <Container maxW="100%">
            ...
            >
              <Link
                ...
                style={{
                  ...
                  borderBottom:
                    activeLink === 'Home' ? '2px solid #3182ce' : 'none',
                  paddingBottom: '4px',
              ...
              <Link
                ...
                style={{
                  ...
                  borderBottom:
                    activeLink === 'Technology' ? '2px solid #3182ce' : 'none',
                  paddingBottom: '4px',
                  textDecoration: 'none', // Remove default underline
                }}
              ...
              <Menu>
                <MenuButton
                  ...
                  borderBottom={
                    activeLink === 'Solutions' ? '2px solid #3182ce' : 'none'
                  }
                  pb={1}
                ...
                <MenuList>
                  {dropdownItems.organization.map((item, index) => (
                    <MenuItem key={index} fontWeight="400">
                      {item}
                    </MenuItem>
                  ))}
                </MenuList>
              ...
              <Menu>
                <MenuButton
                  ...
                  borderBottom={
                    activeLink === 'Industries' ? '2px solid #3182ce' : 'none'
                  }
                  pb={1}
              ...
              <Menu>
                <MenuButton
                  ...
                  borderBottom={
                    activeLink === 'Our Serving' ? '2px solid #3182ce' : 'none'
                  }
                  pb={1}
      ...
      <Drawer isOpen={isOpen} placement="right" onClose={onClose} size="full">
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader borderBottomWidth="1px" fontWeight="400">
            Menu
          </DrawerHeader>
          <DrawerBody>
