    ...
    <Flex position="relative" w="100%">
      ...
      {!value.number && (
        <HStack position="absolute" top="50%" left="100px" transform="translateY(-50%)" pointerEvents="none" zIndex="1" spacing="1">
          <Text color="gray.500" fontSize="0.9375rem" fontFamily="'Wix Madefor Display', sans-serif">e.g. 98765 43210</Text>
          {isRequired && <Text color="red.500">*</Text>}
        </HStack>
      )}
    </Flex>
        ...
        >
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={5}>
            ...
            <Box>
              ...
              <CustomDropdown
                placeholder="Select your country" name="country"
            ...
            <Box>
              ...
              <CustomDropdown
                placeholder="Select business type" name="businessProfile"
            ...
            <Box>
              ...
              <CustomDropdown
                placeholder="Select number of sites" name="numberOfSites"
